...
WORKTREE_DIR=/home/dotmac/projects/dotmac_starter/.worktrees/fix-security-c1-2
...
LOG_FILE=/home/dotmac/projects/dotmac_starter/.seabone/logs/fix-security-c1-2.log
TASK_ID=fix-security-c1-2
DESCRIPTION=Fix\ stored\ XSS\ via\ unsanitized\ branding\ CSS.\ In\ templates/partials/_org_branding_head.html\,\ \'\{\{\ org_branding.css\ \|\ safe\ \}\}\'\ injects\ user-controlled\ CSS\ directly\ into\ every\ page\,\ enabling\ XSS.\ Fix\ approach:\ \(1\)\ In\ the\ branding\ service\ \(look\ in\ app/services/\ for\ branding-related\ service\)\,\ add\ a\ CSS\ sanitization\ function\ that\ strips\ dangerous\ CSS\ patterns\ —\ at\ minimum\ reject:\ javascript:\,\ expression\(\)\,\ behavior:\,\ @import\,\ url\(\)\ with\ non-http\ schemes\,\ and\ any\ content\ containing\ \'\<\'.\ \(2\)\ Apply\ sanitization\ before\ persisting\ branding\ CSS\ in\ the\ service\ layer.\ \(3\)\ In\ the\ template\,\ remove\ \'\|\ safe\'\ if\ the\ stored\ CSS\ is\ now\ safe-by-construction\,\ OR\ keep\ \'\|\ safe\'\ only\ if\ you\'ve\ implemented\ proper\ server-side\ sanitization.\ Prefer\ stripping\ dangerous\ patterns\ over\ a\ full\ allowlist\ for\ now.\ Run\ make\ lint\ and\ make\ type-check\ after\ changes.
