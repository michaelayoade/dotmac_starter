...
WORKTREE_DIR=/home/dotmac/projects/dotmac_starter/.worktrees/fix-deps-5
...
LOG_FILE=/home/dotmac/projects/dotmac_starter/.seabone/logs/fix-deps-5.log
TASK_ID=fix-deps-5
DESCRIPTION=Bump\ FastAPI\ from\ 0.111.0\ to\ \>=0.115.0\ in\ pyproject.toml.\ Interim\ releases\ include\ validation\ bypass\ fixes\ and\ dependency\ injection\ improvements.\ Steps:\ \(1\)\ In\ pyproject.toml\,\ change\ the\ fastapi\ constraint\ to\ \'\>=0.115.0\'.\ \(2\)\ Run\ \'poetry\ update\ fastapi\'.\ \(3\)\ Check\ for\ breaking\ changes\ around\ Depends\(\)\,\ response_model\,\ or\ exception\ handlers\ —\ review\ any\ import\ or\ API\ errors\ after\ update.\ \(4\)\ Run\ \'make\ lint\'\,\ \'poetry\ run\ mypy\ app/\ --ignore-missing-imports\'\,\ \'pytest\ tests/\ -x\ --tb=short\'.\ Fix\ any\ failures\ caused\ by\ the\ version\ change.\ Modify\ ONLY\ pyproject.toml\ \(and\ any\ call\ sites\ that\ break\).\ Do\ NOT\ create\ any\ other\ files.
