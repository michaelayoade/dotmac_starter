...
WORKTREE_DIR=/home/dotmac/projects/dotmac_starter/.worktrees/fix-security-c1-1
...
LOG_FILE=/home/dotmac/projects/dotmac_starter/.seabone/logs/fix-security-c1-1.log
TASK_ID=fix-security-c1-1
DESCRIPTION=Add\ \'.env.agent-swarm\'\ to\ .gitignore\ to\ prevent\ accidental\ credential\ commit.\ The\ file\ .env.agent-swarm\ exists\ in\ the\ project\ root\ and\ contains\ live\ API\ keys\ but\ is\ NOT\ listed\ in\ .gitignore.\ Open\ .gitignore\,\ find\ the\ env\ file\ patterns\ section\ \(around\ line\ 37\)\,\ and\ add\ \'.env.agent-swarm\'\ on\ its\ own\ line.\ Also\ verify\ no\ other\ .env.\*\ files\ with\ credentials\ are\ missing\ from\ .gitignore.\ This\ covers\ findings\ security-c1-1\ and\ security-c1-15.
