...
WORKTREE_DIR=/home/dotmac/projects/dotmac_starter/.worktrees/fix-security-c1-3
...
LOG_FILE=/home/dotmac/projects/dotmac_starter/.seabone/logs/fix-security-c1-3.log
TASK_ID=fix-security-c1-3
DESCRIPTION=Fix\ open\ redirect\ vulnerability\ on\ login\ \'next\'\ parameter.\ In\ app/main.py\ around\ line\ 299\,\ the\ web_auth_redirect_handler\ uses\ exc.next_url\ in\ a\ redirect\ without\ validation\,\ allowing\ redirects\ to\ external\ sites\ \(e.g.\ /admin/login\?next=https://evil.com\).\ Fix:\ validate\ that\ next_url\ starts\ with\ \'/\'\ and\ does\ not\ contain\ \'://\'\ or\ a\ double-slash\ after\ the\ first\ character\ before\ using\ it\ in\ the\ redirect.\ Default\ to\ \'/admin\'\ if\ the\ value\ is\ invalid\ or\ empty.\ Add\ a\ helper\ function\ like\ _safe_next_url\(url:\ str\)\ -\>\ str\ for\ clarity.
