...
WORKTREE_DIR=/home/dotmac/projects/dotmac_starter/.worktrees/fix-security-c1-4
...
LOG_FILE=/home/dotmac/projects/dotmac_starter/.seabone/logs/fix-security-c1-4.log
TASK_ID=fix-security-c1-4
DESCRIPTION=Fix\ stored\ XSS\ via\ \'\{\{\ btn.icon\ \|\ safe\ \}\}\'\ in\ table\ macros\ template.\ In\ templates/admin/components/table_macros.html\ around\ line\ 49\,\ btn.icon\ is\ rendered\ with\ \'\|\ safe\'\ allowing\ arbitrary\ HTML\ injection.\ Fix:\ Replace\ the\ raw\ HTML\ rendering\ with\ a\ safe\ CSS-class-based\ icon\ system.\ \(1\)\ Define\ a\ Python-side\ dict\ or\ Jinja2\ global\ mapping\ icon\ names\ to\ Tailwind/Heroicons\ CSS\ classes\ \(e.g.\ \'edit\'\ -\>\ \'heroicon-pencil\'\,\ \'delete\'\ -\>\ \'heroicon-trash\'\).\ \(2\)\ In\ the\ template\,\ replace\ \'\{\{\ btn.icon\ \|\ safe\ \}\}\'\ with\ a\ class-based\ SVG\ or\ icon\ font\ lookup\ that\ takes\ a\ string\ key\ and\ renders\ a\ predetermined\ safe\ element.\ \(3\)\ Ensure\ all\ call\ sites\ pass\ an\ icon\ name\ string\ \(not\ raw\ HTML\).\ If\ existing\ callers\ pass\ raw\ SVG\ strings\,\ convert\ the\ most\ common\ ones\ to\ named\ keys\ first.\ Run\ make\ lint\ after\ changes.
...
PROMPTS_DIR=/home/dotmac/projects/dotmac_starter/.seabone/prompts
